...
public class MainActivity extends Activity {
	...
	private final View.OnClickListener btnListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.buttonDone:
				...
				((AppController) getApplication()).cropped = mCropView
						.getCroppedBitmap();
			...
			case R.id.button16_9:
				...
				break;
			case R.id.button16_10:
				mCropView.setCropMode(CropImageView.CropMode.RATIO_16_10);
				break;
	...
	private void findViews() {
		...
		findViewById(R.id.button16_10).setOnClickListener(btnListener);
		...
		findViewById(R.id.rotate).setOnClickListener(btnListener);
	...
	public Bitmap getImageForIndex(int index) {
		...
		int resId = getResources().getIdentifier(fileName, "mipmap",
				getPackageName());
